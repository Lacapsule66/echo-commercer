...
import SingleGridItem from "@/components/Shop/SingleProductItem";
...
const ShopWithSidebar = ({ products }: { products: any }) => {
              ...
              <div className="flex gap-7.5">
                ...
                >
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    {/* <!-- category box --> */}
                    <CategoryDropdown attribute="category" />

                    {/* <!-- gender box --> */}
                    {/* <GenderDropdown genders={genders} /> */}

                    {/* // <!-- size box --> */}
                    <SizeDropdown attribute="sizes" />

                    {/* // <!-- color box --> */}
                    <ColorsDropdwon attribute="colors" />

                    {/* // <!-- price range box --> */}
                    {/* <PriceDropdown attribute="discountedPrice" /> */}
                    <RadixSlider attribute="discountedPrice" />
                  </div>
                </div>
                {/* // <!-- Sidebar End --> */}
                ...
                <div className="xl:max-w-[870px] w-full">
                  ...
                  <div>
                    <Hits
                      classNames={{
                        root: "flex",
                        list: `${productStyle === "grid" ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-7.5 gap-y-9" : "flex flex-col gap-7.5"}`,
                      }}
                      hitComponent={({ hit }) => {
                        if (hit.type !== "products") {
                          return null;
                        }
                        ...
                        if (hit?.name === "") {
                          ...
                          return productStyle === "grid" ? (
                            <SingleGridItem item={hit} />
                          ) : (
                            <SingleListItem item={hit} />
                          );
                        }
                      }}
                    />
