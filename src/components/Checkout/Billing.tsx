        ...
        <div>
          ...
          >
            <div className="relative">
              ...
              <div
                className={`mr-2 flex h-4 w-4 items-center justify-center rounded border border-gray-4 ${
                  checkboxToggle && "bg-blue border-blue"
                }`}
              >
                <span
                  className={`opacity-0 ${checkboxToggle && "!opacity-100"}`}
                >
                  <svg
                    width="24"
                    height="24"
