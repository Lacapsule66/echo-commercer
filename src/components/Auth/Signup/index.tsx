          ...
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div className="flex flex-col gap-4.5">
              <button
                ...
                className="flex justify-center items-center gap-3.5 rounded-lg border border-gray-3 bg-gray-1 p-3 ease-out duration-200 hover:text-dark hover:bg-gray-2"
              >
                <svg
                  width="20"
                  height="20"
            ...
            <div className="mt-5.5">
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-white bg-dark py-3 px-6 rounded-lg ease-out duration-200 hover:bg-blue mt-7.5 items-center gap-2"
                >
                  Create Account {loader && <Loader />}
                </button>
